...
DEFAULT_MODEL_PATH = r"C:\\ModelliLiteTF\\EfficientDet-D3.tflite"
DEFAULT_ANNOTATION_PATH = r"C:\\coco2017\\annotations\\instances_val2017.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Esegue l'inferenza con EfficientDet-D3 INT8 su COCO e salva predizioni e statistiche."
        )
    )
